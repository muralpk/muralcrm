            ...
            if ($id == '') {
                ...
                $counter = 1;
                    foreach ($diff as $tdate) {
                        $tdata = array();
                        $tdata['startdate'] = $tdate;
                        $tdata['name'] = "Service #". $counter++ ." on ". $this->input->post('subject');
                        $tdata['duedate'] = $tdate;
                        $tdata['rel_id'] = $id;
                        $tdata['rel_type'] = 'contract';
                        $tdata['status'] = 2;
                        $tdata['is_public'] = 1;
                        $tdata['visible_to_client'] = 1;
                        $this->tasks_model->add($tdata);

                    }
                    
                    // $data['startdate'] = $this->input->post('datestart');
                    // $data['duedate'] = $this->input->post('datestart');
