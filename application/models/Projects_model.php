    ...
    public function get_gantt_data($project_id, $type = 'milestones', $taskStatus = null)
    {
        ...
        foreach ($type_data as $data) {
            ...
            if (count($tasks) > 0) {
                ...
                $values['desc']  = _l('task_total_logged_time') . ' ' . seconds_to_time_format($tasks[0]['total_logged_time']);
                ...
                foreach ($tasks as $task) {
                    ...
                    $values['desc']  = _l('task_total_logged_time') . ' ' . seconds_to_time_format($task['total_logged_time']);
