   ...
   <div class="row">
      <div class="col-md-8 task-single-col-left">
         ...
         <p class="no-margin pull-left" style="margin-right:5px !important;">
            <a href="#" class="btn btn-info" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" onclick="if(confirm('Are you sure?')){mark_complete(<?php echo $task->id; ?>); return false;}" data-toggle="tooltip" title="<?php echo _l('task_single_mark_as_complete'); ?>">
