<?php
// Changed by Azhar for Task list popup
...
foreach ($rResult as $aRow) {
    ...
    if ($aRow['status'] == 5) {
        ...
        $outputStatus .= '<a href="#" onclick="if(confirm(\'Please insure that you call the customer and create the inovice\')){ mark_complete(' . $aRow['id'] . '); return false;}"><i class="fa fa-check task-icon task-unfinished-icon" data-toggle="tooltip" title="' . _l('task_single_mark_as_complete') . '"></i></a>';
    }
